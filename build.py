...
if __name__ == "__main__":
    import subprocess
    subprocess.check_call(['docker', 'run', 'trassiross/conan-gcc8', '-v', 'sources:sources', "pwd"])
    subprocess.check_call(['docker', 'run', 'trassiross/conan-gcc8', '-v', 'sources:sources', "ls", "-la"])
